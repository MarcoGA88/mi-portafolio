...
function About() {
  return (
    <div className="bg-black text-white min-h-screen flex flex-col justify-center items-center px-5 sm:px-10">
      ...
      <div className='px-5'>
        <h1 className="text-4xl sm:text-5xl mb-4 py-5 mt-20">Un poco más sobre mi</h1>
        <p className="text-base md:text-base text-gray-400 mb-6 text-justify">
        ...
        <div className="flex flex-col md:flex-row items-start justify-start space-y-2 md:space-y-0 md:space-x-4 mb-10 text-xs">
          <div className="flex items-center space-x-2 text-gray-500 pt-3">
            <span><MapPin color='rgb(110 231 183)' /></span>
      ...
      <div className="w-full max-w-6xl pl-1 py-4 mt-3">
        <h2 className="text-2xl md:text-3xl mb-8 text-left">Educación</h2>
        <div className="px-5">
          {/* Bachiller */}
          <div className="px-5">
      ...
      <div className="w-full max-w-6xl pl-1 py-4 mt-3">
        ...
        <div className="px-5">
          <p className="text-gray-400 mr-20">
            Dentro del Stack de tecnologías, herramientas y lenguajes de programacion en los que tengo experiencia se encuentran: Figma el cual domino con un enfoque práctico como herramienta de diseño de interfaces, HTML 5 el cual domino en un nivel bastante avanzado, CSS 3 en conjunto con herramientas como Tailwind he conseguido mucha experiencia en esta tecnología, C/C++ en estos lenguajes de programación cuento con al menos 3 años de experiencia en uso constante, en cuanto a C# y JavaScript cuento con bases sólidas y más de algún proyecto desarrollado en estos lenguajes al igual que C/C++ como parte de mi formación académica.
          </p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-start space-y-2 md:space-y-0 md:space-x-4 mb-10 text-xs pt-10">
      ...
      {/* Experience Section*/}
      <div className="w-full max-w-6xl pl-1 py-4 mt-3">
        <h2 className="text-2xl md:text-3xl mb-8 text-left">Experiencia</h2>
        <div className="px-5">
          {/* Pasante 1 */}
          <div className="px-5">
            <h3 className="text-xl mb-2">Pasante de servicios Informáticos</h3>
            <p className="text-gray-400">SmartPC Technology, 2018</p>
          </div>
          <div className='border-dotted border-emerald-300 h-7 border-s-2'></div>
          {/* Pasante 2 */}
          <div className="px-5">
          ...
          <div className="px-5">
            ...
            <p className="text-gray-400">Observatorio Politécnico del Agua, 2024</p>
          </div>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-start justify-start space-y-2 md:space-y-0 md:space-x-4 mb-10 text-xs pt-10">
