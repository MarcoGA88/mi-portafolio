...
import { Home, User, Briefcase, Layers, Mail, Copyright, Twitter, Facebook, Instagram, Dribbble, Menu } from 'lucide-react';
...
function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 w-80 md:min-w-[310px] bg-black text-white p-6 flex flex-col h-full border-r-[1px] border-stone-700 overflow-y-auto z-40 transform ${
